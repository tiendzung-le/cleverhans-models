...
def inception_v3_base(inputs,
    ...
    with variable_scope.variable_scope(scope, 'Nips04InceptionV3', [inputs]):
        with arg_scope(
...
def inception_v3(inputs,
    ...
    with variable_scope.variable_scope(
            scope, 'Nips04InceptionV3', [inputs, num_classes], reuse=reuse) as scope:
        with arg_scope(
...
def inception_v3_arg_scope(weight_decay=0.00004,
    ...
    """Defines the default Nips04InceptionV3 arg scope.
